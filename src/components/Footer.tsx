  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="container">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/faq" className="hover:text-white"> {/* Assuming /faq exists */}
                  FAQ
                </Link>
              </li>
              <li>
                <Link to="/blog" className="hover:text-white"> {/* Assuming /blog exists */}
                  Blog
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>support@crediteval.com</span>
              </li>
              <li className="flex items-start gap-2"> {/* Changed to items-start for multi-line address */}
                <svg
                  className="h-4 w-4"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                {/* Use a div for better control over address lines */}
                <div>
        ...
        <div className="text-center md:text-left"> {/* Center on small screens, left on medium+ */}
